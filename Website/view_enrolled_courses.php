		 	...
		 	<table class="table table-hover">
			    ...
			    <tbody>
			    	...
			    	$i=0;
						...
						$fetch_class="SElECT * from courses where id IN(    SELECT course_id FROM enroll e where user_id='$user_id')";
			    	...
			    	?>
					      <tr>
					        ...
					        <td><a href="view_course.php?id=<?php echo $id;  ?>">View Course</a></td>      
					        <td><a href="unenroll_course.php?id=<?php echo $id;  ?>">Unenroll Course</a></td>
					      </tr>
